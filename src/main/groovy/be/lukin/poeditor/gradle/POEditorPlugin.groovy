    ...
    void apply(Project project) {
        ...
        if (android != null) {
            android.productFlavors.
                    all { flavor ->
                        project.task("poeditorInit${flavor.name}",
                                type: InitTaskGradle,
                                group: GROUP,
        ...
        if (sourceSets != null) {
            project.sourceSets.
                    all { sourceSet ->
                        project.task("poeditorInit${sourceSet.name}",
                                type: InitTaskGradle,
                                group: GROUP,
                                description: "Initialization: create terms & languages for ${sourceSet.name}") {
                            doFirst() {
                                project.poeditor {
                                    variant sourceSet.name
                                }
                            }
                        }
                    }
        ...
        if (android != null) {
            android.productFlavors.
                    all { flavor ->
                        project.task("poeditorPush${flavor.name}",
                                type: PushTaskGradle,
                                group: GROUP,
        ...
        if (sourceSets != null) {
            project.sourceSets.
                    all { sourceSet ->
                        project.task("poeditorPush${sourceSet.name}",
                                type: PushTaskGradle,
                                group: GROUP,
                                description: "Upload translations for ${sourceSet.name}") {
                            doFirst() {
                                project.poeditor {
                                    variant sourceSet.name
                                }
        ...
        if (android != null) {
            android.productFlavors.
                    all { flavor ->
                        project.task("poeditorPushTerms${flavor.name}",
                                type: PushTermsTaskGradle,
                                group: GROUP,
        ...
        if (sourceSets != null) {
            project.sourceSets.
                    all { sourceSet ->
                        project.task("poeditorPushTerms${sourceSet.name}",
                                type: PushTermsTaskGradle,
                                group: GROUP,
                                description: "Upload terms for ${sourceSet.name}") {
                            doFirst() {
                                project.poeditor {
                                    variant sourceSet.name
                                }
        ...
        if (android != null) {
            android.productFlavors.
                    all { flavor ->
                        project.task("poeditorPull${flavor.name}",
                                type: PullTaskGradle,
                                group: GROUP,
        ...
        if (sourceSets != null) {
            project.sourceSets.
                    all { sourceSet ->
                        project.task("poeditorPull${sourceSet.name}",
                                type: PullTaskGradle,
                                group: GROUP,
                                description: "Download translations for ${sourceSet.name}") {
                            doFirst() {
                                project.poeditor {
                                    variant sourceSet.name
                                }
